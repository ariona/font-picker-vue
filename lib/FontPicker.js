  ...
  return _c(
    ...
    [
      ...
      _c(
        "div",
        {
          staticClass: "font-picker-list",
          class: { expanded: _vm.state.expanded }
        },
        [
          _c("div", { staticClass: "font-filter" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
...
__vue_render__._withStripped = true;
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-a308b0f4_0", { source: "\n@charset \"UTF-8\";\n.font-picker {\n  position: relative;\n  display: inline-block;\n  width: 200px;\n  box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.2);\n}\n.font-picker * {\n    box-sizing: border-box;\n}\n.font-picker .font-filter {\n    padding: 10px;\n}\n.font-picker .font-filter input {\n      width: 100%;\n      border: 1px solid #e3e3e3;\n      padding: 5px 10px;\n      font-size: inherit;\n      border-radius: 3px;\n}\n.font-picker p {\n    margin: 0;\n    padding: 0;\n}\n.font-picker button {\n    background: transparent;\n    border: 0;\n    color: inherit;\n    cursor: pointer;\n    font-size: inherit;\n    outline: none;\n}\n.font-picker .dropdown-button {\n    height: 35px;\n    width: 100%;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n    padding: 0 10px;\n    background: #fbfbfb;\n}\n.font-picker .dropdown-button:hover, .font-picker .dropdown-button.expanded, .font-picker .dropdown-button:focus {\n      background: #fbfbfb;\n}\n.font-picker .dropdown-button .dropdown-font-name {\n      overflow: hidden;\n      white-space: nowrap;\n}\n.font-picker .dropdown-button.expanded .dropdown-icon.finished:before {\n      -webkit-transform: rotate(-180deg);\n      transform: rotate(-180deg);\n}\n.font-picker .dropdown-icon {\n    margin-left: 10px;\n}\n.font-picker .dropdown-icon.loading:before {\n      content: '';\n      display: block;\n      height: 10px;\n      width: 10px;\n      border-radius: 50%;\n      border: 2px solid #b2b2b2;\n      border-top-color: black;\n      -webkit-animation: spinner 0.6s linear infinite;\n      animation: spinner 0.6s linear infinite;\n}\n.font-picker .dropdown-icon.finished:before {\n      content: '';\n      display: block;\n      height: 0;\n      width: 0;\n      border-left: 5px solid transparent;\n      border-right: 5px solid transparent;\n      border-top: 6px solid black;\n      transition: -webkit-transform 0.3s;\n      transition: transform 0.3s, -webkit-transform 0.3s;\n      margin: 0 2px;\n}\n.font-picker .dropdown-icon.error:before {\n      content: '⚠';\n}\n.font-picker .font-picker-list {\n    position: absolute;\n    z-index: 1;\n    max-height: 0;\n    width: 100%;\n    overflow-x: hidden;\n    overflow-y: auto;\n    -webkit-overflow-scrolling: touch;\n    margin: 0;\n    padding: 0;\n    background: #fbfbfb;\n    box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.2);\n    transition: 0.3s;\n}\n.font-picker .font-picker-list.expanded {\n      max-height: 300px;\n}\n.font-picker .font-picker-list ul {\n      list-style: none;\n      height: 200px !important;\n      max-height: 200px !important;\n      overflow: auto;\n      position: static !important;\n}\n.font-picker .font-picker-list li {\n      height: 35px;\n      list-style: none;\n}\n.font-picker .font-picker-list li button {\n        height: 100%;\n        width: 100%;\n        display: flex;\n        align-items: center;\n        padding: 0 10px;\n        white-space: nowrap;\n}\n.font-picker .font-picker-list li button:hover, .font-picker .font-picker-list li button:focus {\n          background: #dddddd;\n}\n.font-picker .font-picker-list li button.active-font {\n          background: #d1d1d1;\n}\n@-webkit-keyframes spinner {\nto {\n    -webkit-transform: rotate(360deg);\n    transform: rotate(360deg);\n}\n}\n@keyframes spinner {\nto {\n    -webkit-transform: rotate(360deg);\n    transform: rotate(360deg);\n}\n}\n\n/*# sourceMappingURL=FontPicker.vue.map */", map: {"version":3,"sources":["FontPicker.vue","/Users/iCreativeLabs/Documents/GitHub/FontPicker/src/FontPicker.vue"],"names":[],"mappings":";AAAA,iBAAiB;ACqNjB;EACA,mBAAA;EACA,sBAAA;EACA,aAAA;EACA,2CAAA;CAwIA;AA5IA;IAOA,uBAAA;CACA;AARA;IAWA,cAAA;CAQA;AAnBA;MAaA,YAAA;MACA,0BAAA;MACA,kBAAA;MACA,mBAAA;MACA,mBAAA;CACA;AAlBA;IAsBA,UAAA;IACA,WAAA;CACA;AAxBA;IA2BA,wBAAA;IACA,UAAA;IACA,eAAA;IACA,gBAAA;IACA,mBAAA;IACA,cAAA;CACA;AAjCA;IAoCA,aAAA;IACA,YAAA;IACA,cAAA;IACA,oBAAA;IACA,+BAAA;IACA,gBAAA;IACA,oBAAA;CAeA;AAzDA;MA6CA,oBAAA;CACA;AA9CA;MAiDA,iBAAA;MACA,oBAAA;CACA;AAnDA;MAsDA,mCAAA;MACA,2BAAA;CACA;AAxDA;IA4DA,kBAAA;CA8BA;AA1FA;MA+DA,YAAA;MACA,eAAA;MACA,aAAA;MACA,YAAA;MACA,mBAAA;MACA,0BAAA;MACA,wBAAA;MACA,gDAAA;MACA,wCAAA;CACA;AAxEA;MA2EA,YAAA;MACA,eAAA;MACA,UAAA;MACA,SAAA;MACA,mCAAA;MACA,oCAAA;MACA,4BAAA;MACA,mCAAA;MACA,mDAAA;MACA,cAAA;CACA;AArFA;MAwFA,aAAA;CAAA;AAxFA;IA6FA,mBAAA;IACA,WAAA;IACA,cAAA;IACA,YAAA;IACA,mBAAA;IACA,iBAAA;IACA,kCAAA;IACA,UAAA;IACA,WAAA;IACA,oBAAA;IACA,2CAAA;IACA,iBAAA;CAmCA;AA3IA;MA2GA,kBAAA;CACA;AA5GA;MA+GA,iBAAA;MACA,yBAAA;MACA,6BAAA;MACA,eAAA;MACA,4BAAA;CACA;AApHA;MAuHA,aAAA;MACA,iBAAA;CAkBA;AA1IA;QA2HA,aAAA;QACA,YAAA;QACA,cAAA;QACA,oBAAA;QACA,gBAAA;QACA,oBAAA;CASA;AAzIA;UAmIA,oBAAA;CACA;AApIA;UAuIA,oBAAA;CACA;AAMA;AACA;IACA,kCAAA;IACA,0BAAA;CAAA;CAAA;AAIA;AACA;IACA,kCAAA;IACA,0BAAA;CAAA;CAAA;;AD5PA,0CAA0C","file":"FontPicker.vue","sourcesContent":["@charset \"UTF-8\";\n.font-picker {\n  position: relative;\n  display: inline-block;\n  width: 200px;\n  box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.2); }\n  .font-picker * {\n    box-sizing: border-box; }\n  .font-picker .font-filter {\n    padding: 10px; }\n    .font-picker .font-filter input {\n      width: 100%;\n      border: 1px solid #e3e3e3;\n      padding: 5px 10px;\n      font-size: inherit;\n      border-radius: 3px; }\n  .font-picker p {\n    margin: 0;\n    padding: 0; }\n  .font-picker button {\n    background: transparent;\n    border: 0;\n    color: inherit;\n    cursor: pointer;\n    font-size: inherit;\n    outline: none; }\n  .font-picker .dropdown-button {\n    height: 35px;\n    width: 100%;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n    padding: 0 10px;\n    background: #fbfbfb; }\n    .font-picker .dropdown-button:hover, .font-picker .dropdown-button.expanded, .font-picker .dropdown-button:focus {\n      background: #fbfbfb; }\n    .font-picker .dropdown-button .dropdown-font-name {\n      overflow: hidden;\n      white-space: nowrap; }\n    .font-picker .dropdown-button.expanded .dropdown-icon.finished:before {\n      -webkit-transform: rotate(-180deg);\n      transform: rotate(-180deg); }\n  .font-picker .dropdown-icon {\n    margin-left: 10px; }\n    .font-picker .dropdown-icon.loading:before {\n      content: '';\n      display: block;\n      height: 10px;\n      width: 10px;\n      border-radius: 50%;\n      border: 2px solid #b2b2b2;\n      border-top-color: black;\n      -webkit-animation: spinner 0.6s linear infinite;\n      animation: spinner 0.6s linear infinite; }\n    .font-picker .dropdown-icon.finished:before {\n      content: '';\n      display: block;\n      height: 0;\n      width: 0;\n      border-left: 5px solid transparent;\n      border-right: 5px solid transparent;\n      border-top: 6px solid black;\n      transition: -webkit-transform 0.3s;\n      transition: transform 0.3s, -webkit-transform 0.3s;\n      margin: 0 2px; }\n    .font-picker .dropdown-icon.error:before {\n      content: '⚠'; }\n  .font-picker .font-picker-list {\n    position: absolute;\n    z-index: 1;\n    max-height: 0;\n    width: 100%;\n    overflow-x: hidden;\n    overflow-y: auto;\n    -webkit-overflow-scrolling: touch;\n    margin: 0;\n    padding: 0;\n    background: #fbfbfb;\n    box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.2);\n    transition: 0.3s; }\n    .font-picker .font-picker-list.expanded {\n      max-height: 300px; }\n    .font-picker .font-picker-list ul {\n      list-style: none;\n      height: 200px !important;\n      max-height: 200px !important;\n      overflow: auto;\n      position: static !important; }\n    .font-picker .font-picker-list li {\n      height: 35px;\n      list-style: none; }\n      .font-picker .font-picker-list li button {\n        height: 100%;\n        width: 100%;\n        display: flex;\n        align-items: center;\n        padding: 0 10px;\n        white-space: nowrap; }\n        .font-picker .font-picker-list li button:hover, .font-picker .font-picker-list li button:focus {\n          background: #dddddd; }\n        .font-picker .font-picker-list li button.active-font {\n          background: #d1d1d1; }\n\n@-webkit-keyframes spinner {\n  to {\n    -webkit-transform: rotate(360deg);\n    transform: rotate(360deg); } }\n\n@keyframes spinner {\n  to {\n    -webkit-transform: rotate(360deg);\n    transform: rotate(360deg); } }\n\n/*# sourceMappingURL=FontPicker.vue.map */",null]}, media: undefined });
  ...
  function __vue_normalize__(
    ...
    component.__file = "/Users/iCreativeLabs/Documents/GitHub/FontPicker/src/FontPicker.vue";
